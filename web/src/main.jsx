...
// próprio App. Paleta alinhada à marca (escuro #0b0e14 / acento #f0b429).
class ErrorBoundary extends React.Component {
  ...
  render() {
    ...
    return (
      <div style={{ minHeight: "100vh", boxSizing: "border-box", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px", paddingTop: "calc(24px + env(safe-area-inset-top))", background: "#0b0e14", color: "#e7ecf3", fontFamily: "system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif" }}>
        <div style={{ width: "100%", maxWidth: "420px", textAlign: "center" }}>
          ...
          <button
            ...
            style={{ minHeight: "44px", padding: "11px 22px", borderRadius: "9px", border: "1px solid #f0b429", background: "rgba(240,180,41,.15)", color: "#f0b429", fontWeight: 700, fontSize: "14px", cursor: "pointer" }}
          >
            Recarregar
          </button>
