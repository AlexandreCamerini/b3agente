...
# acceptance_criteria do 14-01-PLAN.md ("score >= 40", histórico; a régua
# vigente desde 2026-09-08, quick 260908-ldg, é a escala de três faixas em
# `options_quant.faixa_de_liquidez`, NEGOCIÁVEL >=55).
#
...
# contrato sintético (OTM, spread ~15%) score 61 — NEGOCIÁVEL com margem, não
# fio de navalha (com 500 seria 41, DIFÍCIL sob a escala vigente).
MOCK_VOLUME = 5000
