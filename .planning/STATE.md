...
status: planned
stopped_at: 'Fase 37 (Gráfico de Payoff e Explicação Confiáveis) — planejada: 5 planos/3 ondas (37-01..37-05), gsd-plan-checker VERIFICATION PASSED (após 1 ciclo de revisão), decision-coverage-gate 8/8. Pronta para `/gsd-execute-phase 37`. Guardrail aplicado: nenhum mutador `gsd-sdk query state.*`/`roadmap.*` foi chamado — STATE.md editado à mão.'
