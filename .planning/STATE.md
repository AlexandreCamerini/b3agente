...
'atraso'` ×2) e as 23 asserções do bloco 12 do guardião de front também
(`14 FALHA(S)`). Todo teste novo fixa o relógio por `_hoje`: nenhum muda de
