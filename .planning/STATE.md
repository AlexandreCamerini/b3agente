...
Last activity: 2026-09-09 — quick 260909-dao, `TESTFLIGHT.md` corrigido: o App Name do App Store Connect ("Boris+ Simulador B3", escolha do Alex) colidiu com apps "Boris" já publicados — campo diferente do `CFBundleDisplayName`, que continua "Boris+" sob o ícone. Antes disso: quick 260909-bwm (script master `distribuir-iphone.sh`) rodado ao vivo, achou e corrigiu um bug real de caminho (entitlements), gerou o build 10 de TestFlight com sucesso. Em paralelo, verificação ao vivo confirmou que o gate de liquidez (promovido em 260908-*) está funcionando em produção: PETR4/VALE3/ABEV3 leem `COMPRAR/alta` hoje (por isso "Oportunidades de opções" mostra "sem_setup", não o defeito antigo) — mapeados 6 tickers do catálogo em `NÃO OPERAR` (BBDC4/BBAS3/B3SA3/EQTL3/VIVT3/BPAC11) pra testar venda coberta de verdade.
