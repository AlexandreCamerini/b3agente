...
Last activity: 2026-09-11 — **produção em `F10-20260911-02`** com tudo do dia (família do `qty` falsy nas 5 rotas, fuso do prazo que mudava o gate de liquidez, carimbos visíveis). **Build 11 enviado ao TestFlight** (front `F10-20260910-02`, o mais recente; `aps-environment` segue `development`, então push NÃO chega neste build — flip é ação coordenada com o Railway, deliberadamente não feita). Pendente de publicação de FRONT: quick 260911-k9g (rodapé com os dois carimbos) — decisão do Alex se sobe agora (build 12) ou junta com a próxima entrega de interface. Aberto, aguardando decisão: **A-12** (bootstrap do 1º admin) e **D-01** (recusa por rate limit diz "cota do dia esgotada" com uso 0).
