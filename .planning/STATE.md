...
Last activity: 2026-09-11 — **auditoria de 2026-09-10 fechada nos achados de peso**. Corrigidos nesta rodada: A-07 (cota de IA com reserva atômica + devolução do saldo), A-08 (agente não anuncia venda que não houve), A-17/A-18 (dois guardiões provados cegos, agora com prova invertida), além do lote A-01 a A-05 e do A-00 mais cedo. Suíte em 2281 pytest + 126 mjs. **Nada disto foi deployado**: produção está em `F10-20260910-03` com o lote A-01 a A-05 (se o clique foi dado) e as correções desta rodada exigem novo deploy só-backend com bump manual. Aberto, pequeno: A-09/A-10/A-14/A-15/A-16 (baixos), ValueError de `/api/options/buy`, e D-01 (recusa por rate limit se apresenta como "cota do dia esgotada" — mexe em contrato que a UI lê, pede decisão do Alex). A-06 fechado sem ação (produção leva 1-6 s).
