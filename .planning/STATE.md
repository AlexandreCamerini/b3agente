...
Last activity: 2026-09-09 — quick 260909-th4: `SERVER_BUILD_ID` bumpado para `F10-20260909-01` (deploy só-backend da correção de fuso 260909-oyu, PR #36 mesclado em f238b53). **Deploy pendente de clique do Alex no Railway**; confirmação = `/api/health` responder o id novo. Upload do build 10 ao TestFlight ainda sem confirmação.
