...
Last activity: 2026-09-11 — **D-2 fechado nas duas partes**: carimbos visíveis e aritmética de prazo agora em BRT. A segunda mudava decisão de verdade — contrato na borda de 15 dias era recusado pelo gate de liquidez entre 21h e 24h só por causa do relógio do servidor. Acumulado na branch e **pendente de deploy só-backend**: 260911-cf1, 260911-ctd, 260911-dcq, 260911-dtx (mais 260911-15a e 260911-axj, que já têm o bump `F10-20260911-01` em `main` mas ainda não foram ao ar). Produção em `F10-20260910-04`. Suíte em 2342 pytest + 126 mjs. Aberto, aguardando decisão: **A-12** (bootstrap do 1º admin) e **D-01** (recusa por rate limit diz "cota do dia esgotada" com uso 0). Achado de ferramental a lembrar: teste que reimporta `app.main` pode deixar o atributo do pacote divergente e furar patch de relógio.
